...
description: "Create Blockopolio game."
tags: tutorial, ethereum, smart-contract, reactors
type: blog
---

![Title](/images/image-00.png)

In this tutorial, you will learn step by step how to create the game Blockopolio, a fun variation on a famous boardgame. The main idea maps really nicely to Blockchain systems and we are going to build portions of the game to show it.

# The game - Criando o projeto - Setup the project

Nosso jogo é composto de 3 smart contracts 
Bank
AssetManager
Banker

Start by completing the Bank contract.
Then move on to complete the AssetManager contract.
Finish up with the Banker contract.


# Overview

Here is a summary of the steps to be taken to build our game:

1. Installation requirements;
2. 
3. Inicializar projeto com Truffle e Open Zeppelin;
4. Configurar Truffle para se conectar na testnet RSK;
5. Criar uma carteira e adquirir alguns testnet R-BTCs;
6. Inicializar o frontend;
7. Adicionar mais algumas configurações ao Truffle;
8. Criar o smart contract do token e compilar;
9. Preparar o deploy no Truffle;
10. Fazer a publicação na testnet RSK com Truffle;
11. Customizar o frontent;
12. Interagir com o smart contract.
...
3. Metamask - extensão para o google chrome
4. Remix

## Node.js e NPM

Uma dependência é NPM, que é instalado com Node.js.
...
# Criando o projeto - Setup the project
